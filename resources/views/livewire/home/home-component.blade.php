        ...
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7">
                <div class="site-heading">
                    <h1>News Article </h1>
                    <span class="subheading">All Articles</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row gx-4 gx-lg-5 justify-content-center">
        <div class="col-md-10 col-lg-8 col-xl-7">
           ...
           {{ $articles->links()  }}
            ...
            <!-- Pager-->
            <div class="d-flex justify-content-end mb-4"><a class="btn btn-primary text-uppercase" href="{{ route('latest') }}">Latest Articles →</a></div>
        </div>
    </div>
</div>
</div>
